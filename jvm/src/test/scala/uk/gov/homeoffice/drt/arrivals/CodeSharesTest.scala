...
import uk.gov.homeoffice.drt.arrivals.ArrivalGenerator.live
import uk.gov.homeoffice.drt.arrivals.CodeShares.uniqueFlightsWithCodeShares
...
class CodeSharesTest extends Specification {
