...
object AirportConfigs {
  val allPorts: List[AirportConfigLike] = List(Abz, Bfs, Bhd, Bhx, Brs, Boh, Cwl, Dsa, Edi, Ema, Ext, Gla, Huy, Inv, Lba, Lcy, Lgw, Lhr, Lpl, Ltn, Man, Mme, Ncl, Nqy, Nwi, Pik, Sou, Stn)
