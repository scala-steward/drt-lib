...
object Man extends AirportConfigLike {
  ...
  val config: AirportConfig = AirportConfig(
    ...
    terminalProcessingTimes = Map(T1 -> Map(
      b5jsskToDesk -> 0, //53d / 60,
      b5jsskChildToDesk -> 0, //53d / 60,
